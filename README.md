\[!\[CRAN\_Status\_Badge](http://www.r-pkg.org/badges/version/DatabionicSwarm)](https://cran.r-project.org/package=DatabionicSwarm)
...
\# Generalized U-Matrix computed on the GPU
...
remotes::install\_github("Mthrun/DatabionicSwarm")
